...
"}")
        ...
        self.pushButton_3.clicked.connect(self.widget.update)
        self.pushButton.clicked.connect(self.widget.update)
        self.pushButton_4.clicked.connect(self.widget.update)
        self.pushButton_5.clicked.connect(self.widget.update)
        self.pushButton_6.clicked.connect(self.widget.update)
